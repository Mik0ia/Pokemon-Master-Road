...
class PokemonPokedexInfo_Scene 
  ...
  def drawPageData
	...
	@sprites["infoverlay"].setBitmap(_INTL("Graphics/UI/Pokedex/bg_data"))
	...
	@sprites["leftarrow"] = AnimatedSprite.new("Graphics/UI/left_arrow_green", 8, 40, 28, 2, @viewport)
    @sprites["leftarrow"].x       = -2
    @sprites["leftarrow"].y       = 46
    @sprites["leftarrow"].visible = false
    @sprites["leftarrow"].play
    @sprites["rightarrow"] = AnimatedSprite.new("Graphics/UI/right_arrow_green", 8, 40, 28, 2, @viewport)
