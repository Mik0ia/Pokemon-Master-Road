...
class PokemonPokedexInfo_Scene
  ...
  #-----------------------------------------------------------------------------
  DATA_TEXT_TAGS = [
    shadowc3tag(Color.new(168, 184, 184), Color.new(88, 88, 80)), # Black
    shadowc3tag(Color.new(248, 168, 184), Color.new(232, 32, 16)), # Red
    shadowc3tag(Color.new(120, 184, 232), Color.new(0, 112, 248)), # Blue
    shadowc3tag(Color.new(174, 208, 144), Color.new(96, 176, 72)), # Green
	shadowc3tag(Color.white,  Color.new(132,132,132))			   # White
  ]
